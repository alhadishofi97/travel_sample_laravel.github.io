            ...
            <div class="row">
                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method = "POST" action="{{ route('checkout-create', $item->id) }}" >
                                ...
                                <button type="submit" class="btn btn-add-now mb-2 mb-2 px-4">
                                    Add Now
                                </button>
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right">  $ {{ $item->additional_visa}}, 00
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div class="bank">
                            <div class="bank-item pb-3">
                                <img src="{{ url('frontend/images/ic_card.png')}}" alt="" class="bank-images">
                    ...
                    <div class="join-container">
                        <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block btn-join-now mt-3 py-2"> I have Made a Payment</a>
                    </div>
