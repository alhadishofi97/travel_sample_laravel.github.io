                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="{{ url('frontend/images/member1.png')}}" class="member-image mr-8">
                            <img src="{{ url('frontend/images/member2.png')}}" class="member-image mr-8">
                            <img src="{{ url('frontend/images/member3.png')}}" class="member-image mr-8">
                            <img src="{{ url('frontend/images/member4.png')}}" class="member-image mr-8">
                            <img src="{{ url('frontend/images/member5.png')}}" class="member-image mr-8">
                            <img src="{{ url('frontend/images/member6.png')}}" class="member-image mr-8">
                        </div>
                        <hr>
